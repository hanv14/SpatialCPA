...
TOOLS_DIR = Path(__file__).resolve().parents[3] / "tools" / "isost"
N_PCS = 50
...
def main():
    parser = argparse.ArgumentParser(description="isoST virtual slice generation")
    ...
    method_params = {"seed": args.seed, "epochs": args.epochs, "device": args.device}
