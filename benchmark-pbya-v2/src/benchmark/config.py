...
METHODS = {
    "spatialcpav15_gen": {
        "wrapper": "src/benchmark/methods/run_spatialcpav15.py",
    ...
    "spatialcpav13_gen": {
        "wrapper": "src/benchmark/methods/run_spatialcpav13.py",
        "conda_env": "bench_spatialcpa",
        "available": True,
        "generation_native": True,
    },
    "spatialcpav12_gen": {
        "wrapper": "src/benchmark/methods/run_spatialcpav12.py",
        "conda_env": "bench_spatialcpa",
        "available": True,
        "generation_native": True,
    },
    "spatialcpav11_gen": {
        "wrapper": "src/benchmark/methods/run_spatialcpav11.py",
        "conda_env": "bench_spatialcpa",
        "available": True,
        "generation_native": True,
    },
    "spatialcpav10_gen": {
        "wrapper": "src/benchmark/methods/run_spatialcpav10.py",
        "conda_env": "bench_spatialcpa",
        "available": True,
        "generation_native": True,
    },
