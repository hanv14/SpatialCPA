"""Cross-dataset figures for the benchmark, in the Nature/Springer theme.
...
Usage:
    ...
    python -m src.bench3.plot_cross_dataset \\
      --method-order spatialz feast isost spatialcpav18_gen \\
      --method-names spatialz=SpatialZ feast=FEAST isost=isoST \\
                     spatialcpav18_gen="SpatialCPA v18" \\
...
def main():
    ap = argparse.ArgumentParser(
        description="Cross-dataset figures, in the Nature/Springer theme",
        ...
        epilog=(
            ...
            "    --method-names spatialz=SpatialZ 'spatialcpav18_gen=SpatialCPA v18'\n"
            "    --dataset-names starmap_visual_cortex='STARmap V1'\n"))
    ...
    ap.add_argument("--include-gen", action="store_true",
                    help="add the gen_* generation metrics as a fifth ranking criterion")
    ...
    print(f"benchmark — cross-dataset figures (design={args.design})")
