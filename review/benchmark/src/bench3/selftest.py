"""Validate the harness with synthetic reconstructions of known quality.
...
sys.path.insert(0, str(PROJECT_ROOT / "src" / "bench3" / "methods"))
...
def main():
    ap = argparse.ArgumentParser(description="Validate the harness end to end")
