"""Figures for the benchmark — the SpatialZ paper's validation, drawn.
...
Usage:
    ...
    python -m src.bench3.plot_paper_figures --methods spatialz spatialcpav18_gen
"""
...
def main():
    ap = argparse.ArgumentParser(description="Draw the paper figures")
