"""Correspondence-free evaluation for de-novo virtual-slice generation.
...
* ``morans_agreement`` — Pearson r between per-gene Moran's I of prediction and
  ...
  whether the *same genes* are spatially structured. (This is what the
  ``morans_i_median`` metric describes but does not compute.)
