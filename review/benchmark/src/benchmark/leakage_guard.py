"""Central leakage-prevention utilities for the benchmark.

The benchmark is leakage-hardened. Every
...
3. **Held-out geometry**: methods are given only a scalar **target z** (a
   position), never the held-out (x, y). Enforced by the wrapper interface.
