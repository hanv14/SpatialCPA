...
:class:`~spatialcpav4.model.SpatialCPATransformer`, a
:class:`~spatialcpav4.data.SliceStack`, precomputed
:class:`~spatialcpav4.data.TripletSamples`, and a
:class:`~spatialcpav4.config.SpatialCPAv4Config`.
"""
...
from .config import SpatialCPAv4Config
...
def load_model(checkpoint_path: str, device: Optional[str] = None) -> SpatialCPATransformer:
    ...
    config = SpatialCPAv4Config.from_dict(ckpt["config"])
    model = SpatialCPATransformer(
