...
| panel | A1n. permutation null (real counts shuffled) | **-0.0080** | -0.5866 .. +0.4307 (20) | -0.3361 | 0.4723 | 28 |
...
|---|---|---|---|
| **R1** `corr(I_real, control)` — is the tissue's ordering a sparsity ordering? | +0.2862 | +0.4171 | +0.2559 |
| **R2** `corr(I_4, control)` | +0.1785 | +0.3566 | +0.1895 |
| **R3** partial `corr(I_4, I_real given control)` | +0.4847 | +0.3593 | +0.4339 |
| retained fraction of `r` = +0.5076 | 95.5% | 70.8% | 85.5% |

**UNINFORMATIVE — the control specifications disagree** — the 3 specifications span 0.247 against a 0.150 tolerance (`ladder_preregistration.md` §4, `flanking_copy_preregistration.md` §3).
...
`spatial_scramble` keeps every per-gene marginal and destroys only position: **-0.0080** (sd 0.2970, 20 seeds).
...
|---|---|---|---|---|
| 10 genes | **+0.1231** | -0.1414 .. +0.2976 | 12.9% | 20 |
...
| retained fraction of `r` = +0.9517 | 100.1% | 100.2% | 100.8% |
...
`F3_copy` = **+0.1231** (median over widths [10], span 0.000); `r_copy` = **+0.9517**; denominator **+0.8286**.

| rung | raw `r` | its own F3 (abundance alone) | **rescaled** |
|---|---|---|---|
| flanking_copy | +0.9517 | +0.1231 | **1.00** |
| A1b-t | +0.8341 | +0.0559 | **0.86** |
| A1b | +0.8341 | +0.0558 | **0.86** |
| A1b-p | +0.8334 | +0.0892 | **0.86** |
| A1c | +0.8333 | +0.0920 | **0.86** |
| A1a | +0.6927 | +0.1604 | **0.69** |
| 4 | +0.5076 | +0.0329 | **0.46** |
| A1n | -0.3928 | -0.0692 | **-0.62** |
