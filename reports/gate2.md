...
2026-08-24 23:54 UTC, Python 3.12.14 on
...
| retrieval neighbourhoods | 64.0 of K = 32 neighbours change per cell |
...
| **G2.1h-c** | MUTATION: querying **retrieval** in the model frame instead of the data frame changes this many of the K neighbours per cell, on average<br><sub>out of K = 32</sub> | 63.9697 | `> 0` | **PASS** |
