...
Dataset `starmap_visual_cortex`, holdout `paper_2_4_6` (**tier 1**, `specs/10` §1). Config `dec8bc949402b5a1` from defaults, seed 1.
...
|---|---|---|
| `paper_morans_pearson` | +0.3753 | +0.5077 |
| `paper_gearys_pearson` | +0.3757 | +0.5052 |
| `paper_umap_mixing` | +0.6067 | +0.6589 |
| `paper_marker_field_r` | +0.4718 | +0.4524 |
| `paper_marker_depth_r` | +0.6977 | +0.6974 |
| `paper_celltype_localization` | +0.7591 | +0.7580 |
| `paper_gene_mean_spearman` | +0.9376 | +0.9403 |
...
|---|---|---|---|---|---|
| `uncalibrated` | `morans_pearson` | +0.2949 | +0.5128 | +0.3753 | +0.3753 |
| `uncalibrated` | `gearys_pearson` | +0.2944 | +0.5158 | +0.3757 | +0.3757 |
| `uncalibrated` | `umap_mixing` | +0.7061 | +0.6011 | +0.6067 | +0.6067 |
| `uncalibrated` | `marker_field_r` | +0.4578 | +0.4886 | +0.4718 | +0.4718 |
| `uncalibrated` | `marker_depth_r` | +0.6977 | +0.7304 | +0.6964 | +0.6977 |
| `uncalibrated` | `celltype_localization` | +0.6925 | +0.7591 | +0.7853 | +0.7591 |
| `detection-calibrated` | `morans_pearson` | +0.6049 | +0.5077 | +0.4188 | +0.5077 |
| `detection-calibrated` | `gearys_pearson` | +0.6016 | +0.5052 | +0.4240 | +0.5052 |
| `detection-calibrated` | `umap_mixing` | +0.7471 | +0.6475 | +0.6589 | +0.6589 |
| `detection-calibrated` | `marker_field_r` | +0.4524 | +0.4557 | +0.4477 | +0.4524 |
| `detection-calibrated` | `marker_depth_r` | +0.6455 | +0.7117 | +0.6974 | +0.6974 |
| `detection-calibrated` | `celltype_localization` | +0.6925 | +0.7580 | +0.7813 | +0.7580 |
...
```
{
  ...
  "lengthscale": {
    "ell_xy": 11.490771589904071,
    "ell_z": 5.5,
    "status": "converged",
    "ell_z_status": "boundary",
    "ell_fitted_xy": 116.31226054120532,
    "ell_fitted_z": 132.0,
    "i_gen": 0.25565817952156067,
    "i_target": 0.2611113265156746,
    "z_achieved": 0.9788444407877304,
    "z_target": 0.9570073884273124,
    "iterations": 2,
    "applied_ell_xy": 11.490771589904071,
    "applied_ell_z": 100.0
  },
  "detection": {
    "measured": true,
    ...
    "detection_mae_gen_vs_real": 0.008208480860519852,
    "seconds": 6.8
  },
  "anchor": {
    "fitted": false,
...
|---|---|---|
| `ell_xy` | 11.5 um | converged |
| `ell_z` | 5.5 um | boundary (bound, not a fit — R1) |
| fitted `ell` | 116.3 / 132.0 um | variogram |
| Moran's I | gen 0.2557 vs flanking 0.2611 | 2 iterations |
| between-section r | gen 0.9788 vs observed 0.9570 | R1 remedy 2 |
...
|---|---|---|---|---|
| 0 | 9 | 0.3365 | 0.3871 | 0.1376 |
| 1 | 8 | 0.2284 | 0.3357 | 0.1202 |
| 2 | 6 | 0.2294 | 0.1614 | 0.0680 |
| 3 | 5 | 0.3153 | 0.4899 | 0.1798 |
...
* variance ratio: min 0.0085, median 0.1404, last 1.0357 over 241 logged steps
* spatial ratio: min -0.0212, median 2.4322, last 2.3664 over 241 logged steps
## Provenance
