...
|---|---|
| `paper_morans_pearson` | +0.6541 |
| `paper_gearys_pearson` | +0.6535 |
| `paper_umap_mixing` | +0.9262 |
| `paper_marker_field_r` | +0.6824 |
| `paper_marker_depth_r` | +0.8331 |
| `paper_celltype_localization` | +0.7546 |
| `paper_gene_mean_spearman` | +0.9901 |
...
| `paper_marker_field_r` | +0.6824 |
| `paper_marker_depth_r` | +0.8331 |
| `paper_celltype_localization` | +0.7751 |
| `paper_gene_mean_spearman` | +0.9901 |
