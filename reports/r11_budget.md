...
|---|---|---|---|---|---|---|---|
| `softplus` | section_2 | 11225.8 | 11168 | 4187 | **2.68x** | **99.5%** | no |
| `softplus` | section_4 | 6203.2 | 146 | 4102 | **1.51x** | **2.4%** | **yes** |
| `softplus` | section_6 | 3821.3 | 3788 | 4162 | **0.92x** | **99.1%** | no |
| `exp` | section_2 | 70046.1 | 48343 | 4187 | **16.73x** | **69.0%** | **yes** |
| `exp` | section_4 | 8762.9 | 92 | 4102 | **2.14x** | **1.0%** | **yes** |
| `exp` | section_6 | 3752.7 | 3719 | 4162 | **0.90x** | **99.1%** | no |
